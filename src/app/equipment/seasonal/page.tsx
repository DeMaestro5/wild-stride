'use client';
// app/equipment/seasonal/page.tsx
...
export default function SeasonalEquipment() {
  ...
  // Get the active season data (currently hardcoded to winter)
  const currentSeason =
  ...
  const handleSeasonChange = (seasonId: string) => {
    ...
    // In a real app, this would trigger loading the appropriate seasonal data
      ...
      <div className='relative h-screen' id='hero'>
        ...
        <div className='relative z-10 h-full'>
          ...
          {/* <div className='absolute top-28 left-0 right-0 z-20'>
            <SeasonalSalesAlert
              message='Winter Clearance: Up to 40% off select cold-weather gear'
              linkText='Shop Now'
            ...
            extraContent={
              <div className='mt-8 bg-black bg-opacity-50 p-6 rounded-lg max-w-2xl'>
                ...
                <div className='flex space-x-4'>
                  ...
                  <Link
                    href={`/equipment/seasonal/${currentSeason.id}/guide`}
        ...
        <div className='container mx-auto px-4 space-y-16 md:space-y-24 py-12 md:py-20'>
          ...
          <section id='section-01' className='pt-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
              {winterConditions.map((condition, index) => (
          ...
          <section id='section-02' className='pt-12 mt-4'>
            <FeaturedGearGrid
              ...
              items={winterFeaturedGear}
              showSeasonalTags={true}
            />

            <div className='mt-10 text-center'>
              <Link
                href={`/equipment/seasonal/${currentSeason.id}/all`}
          ...
          >
            <div className='mb-12'>
              <div className='flex items-center mb-4'>
                <div className='h-px w-16 bg-yellow-400 mr-4'></div>
                <span className='text-yellow-400 tracking-widest uppercase text-sm font-medium'>
                  {currentSeason.name.toUpperCase()} WARMTH
                </span>
              </div>
              ...
              <p className='text-gray-400 max-w-3xl'>
                Master the three-layer system to stay comfortable in changing{' '}
            ...
            <LayeringSystem layers={winterLayeringSystem} />
            ...
            <div className='mt-12 p-6 bg-gray-700 rounded-lg'>
              ...
              <Link
                href={`/equipment/seasonal/${currentSeason.id}/outfit-builder`}
          ...
          <section id='section-05' className='pt-12 mt-4'>
            ...
            <SeasonalPackingList
              essentialItems={winterPackingList.essential}
              optionalItems={winterPackingList.optional}
              seasonName={currentSeason.name}
              downloadUrl={winterPackingList.downloadUrl}
            />
          </section>
          ...
          >
            ...
            <div className='flex flex-col md:flex-row gap-8'>
              <div className='md:w-1/2'>
                <SeasonalTrailMap
                  mapImage={winterTrails.mapImage}
                  mapAlt={winterTrails.mapAlt}
                  regionName={winterTrails.regionName}
                />
              </div>
              <div className='md:w-1/2 space-y-6'>
                {winterTrails.trails.slice(0, 2).map((trail) => (
                ...
                <div className='mt-6'>
                  <Link
                    href={winterTrails.allTrailsUrl}
          ...
          <section id='section-08' className='pt-12 mt-8'>
            ...
            <GearMaintenanceTips tips={winterMaintenanceTips} />
          </section>
          ...
          <section id='section-09' className='pt-12 mt-8'>
            ...
            <TestimonialSlider testimonials={winterTestimonials} />
          </section>
          ...
          >
            <SustainabilityFeature
              title={winterSustainability.title}
              description={winterSustainability.description}
              stats={winterSustainability.stats}
              brandsHighlighted={winterSustainability.brandsHighlighted}
              callToAction={winterSustainability.callToAction}
            />
          </section>
          ...
          <section id='section-11' className='pt-12 mt-8'>
            <SeasonalTips
              title={winterSafetyTips.title}
              description={winterSafetyTips.description}
              tips={winterSafetyTips.tips}
              linkText={winterSafetyTips.linkText}
              linkUrl={winterSafetyTips.linkUrl}
            />
          </section>
          ...
          <section className='pt-12 mt-8 mb-16'>
            <SeasonalEquipmentGuide
              title={winterEquipmentGuide.title}
              description={winterEquipmentGuide.description}
              coverImage={winterEquipmentGuide.coverImage}
              downloadUrl={winterEquipmentGuide.downloadUrl}
              features={winterEquipmentGuide.features}
            />
          </section>
        </div>
      </div>
